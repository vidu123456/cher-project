...
function Lesson2({ coins, setCoins, progress, setProgress }) {
  ...
  const questions = [
    {
      text: "A general home inspection typically covers the electrical, plumbing, HVAC, and structural systems.",
      options: ["True", "False"],
      correctIndex: 0,
    },
    {
      text: "Pest inspections only look for termites.",
      options: ["True", "False"],
      correctIndex: 1,
    },
    {
      text: "Mold inspections can detect invisible mold spores.",
      options: ["True", "False"],
      correctIndex: 0,
    },
    {
      text: "Well water inspections test for bacteria and chemicals.",
      options: ["True", "False"],
      correctIndex: 0,
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center inset-0 fixed justify-center bg-indigo-300">
      ...
      <Header
        className="text-6xl mb-15 whitespace-pre-line text-center text-indigo-500"
        title={`Different Types of Home Inspections`}
        subtitle={`True or False Quiz`}
      />
